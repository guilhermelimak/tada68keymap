...
qk_tap_dance_action_t tap_dance_actions[] = {
  [BRT] = ACTION_TAP_DANCE_FN_ADVANCED(
    NULL,
    dance_breath_rate,
    NULL
  ),

  [LYR] = ACTION_TAP_DANCE_FN_ADVANCED(
    NULL,
    dance_layers,
    dance_layers_finish
  )
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |----------------------------------------------------------------|
     * |Ctrl|Win |Alt |        Space          |Alt|LYR|Ctrl|Lef|Dow|Rig |
     * `----------------------------------------------------------------'
     */
  [_BASE] = KEYMAP_ANSI(
    ...
    KC_LCTL, KC_LGUI,KC_LALT,                KC_SPC,                        KC_RALT,TD(LYR),KC_RCTRL, KC_LEFT,KC_DOWN,KC_RGHT
  ),
  ...
  [_FN] = KEYMAP_ANSI(
    ...
    _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______, \
    _______,KC_VOLD,KC_MUTE,KC_VOLU,_______,_______,_______,KC_LEFT,KC_DOWN,KC_UP ,KC_RIGHT,_______,        _______,_______, \
    _______, BL_DEC,BL_TOGG, BL_INC,TD(BRT),_______,_______,_______,_______,_______,_______,_______,_______,_______,         \
    _______,_______,_______,                BL_BRTG,                _______,_______,KC_MPLY,_______,_______,_______
  ),
